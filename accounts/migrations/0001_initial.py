    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roles', models.CharField(choices=[('Donater', 'Donater'), ('hospital', 'hospital'), ('Blood needer', 'Blood needer')], max_length=50, null=True)),
                ...
                ('date', models.DateField(blank=True, default='2022-01-01', null=True)),
